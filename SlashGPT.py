...
class Main:
    ...
    def process_llm(self):
        try:
            ...
            if self.session.has_emit():
                (action_data, emit_method) = self.session.get_emit_data()
            ...
            if self.session.should_call_function_call():
                (
                    function_message,
                    function_name,
                    role,
                ) = self.session.process_function_call(
