...
class VectorDBBase(metaclass=ABCMeta):
    ...
    def fetch_related_articles(self, messages: List[dict], llm_model: LlmModel, token_budget: int) -> str:
        ...
        return self.results_to_articles(results, query, messages, llm_model, token_budget)
    ...
    def results_to_articles(self, results: List[str], query: str, messages: List[dict], llm_model: LlmModel, token_budget: int) -> str:
        return self.vectorEngine.results_to_articles(results, query, messages, llm_model, token_budget)
